...
VALUES
    (
        ...
        FALSE,
        FALSE,
        '{"ΝΕΚΡΟΤΑΦΕΙΟ ΖΩΓΡΑΦΟΥ", "ΝΟΣΟΚΟΜΕΙΟ ΕΥΑΓΓΕΛΙΣΜΟΣ", "ΣΥΝΤΑΓΜΑ", "ΓΑΛΑΤΣΙ"}'
    ),
    (
        'X95',
        'ΣΥΝΤΑΓΜΑ',
        ...
        TRUE,
        TRUE,
        '{"ΣΥΝΤΑΓΜΑ", "ΝΟΣΟΚΟΜΕΙΟ ΕΥΑΓΓΕΛΙΣΜΟΣ", "ΚΤΙΡΙΟ ΑΝΑΧΩΡΗΣΕΩΝ"}'
    ),
    (
        '224',
        'ΚΑΙΣΑΡΙΑΝΗΣ',
        ...
        FALSE,
        FALSE,
        '{"ΚΑΙΣΑΡΙΑΝΗΣ", "ΝΟΣΟΚΟΜΕΙΟ ΕΥΑΓΓΕΛΙΣΜΟΣ", "ΤΕΡΜΑ ΕΛ. ΒΕΝΙΖΕΛΟΥ"}'
    );
...
VALUES
    ...
    ('ΓΑΛΑΤΣΙ', TRUE, '{ "608, ΝΕΚΡΟΤΑΦΕΙΟ ΖΩΓΡΑΦΟΥ - ΓΑΛΑΤΣΙ" }'),
    (
    ...
    ('ΤΕΡΜΑ ΕΛ. ΒΕΝΙΖΕΛΟΥ', FALSE, '{ "224, ΚΑΙΣΑΡΙΑΝΗΣ - ΤΕΡΜΑ ΕΛ. ΒΕΝΙΖΕΛΟΥ" }'),
    ('ΚΤΙΡΙΟ ΑΝΑΧΩΡΗΣΕΩΝ', TRUE, '{ "X95, ΣΥΝΤΑΓΜΑ - ΚΤΙΡΙΟ ΑΝΑΧΩΡΗΣΕΩΝ" }'),
    ('ΚΑΙΣΑΡΙΑΝΗΣ', FALSE, '{ "224, ΚΑΙΣΑΡΙΑΝΗΣ - ΤΕΡΜΑ ΕΛ. ΒΕΝΙΖΕΛΟΥ" }');